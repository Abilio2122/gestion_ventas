...
public class gestion_ventas {
    ...
    public static void main(String[] args)throws IOException, excepcionPersonalizada {
        ...
        gestionEventos.importarEventosDesdeCSV("C:\\Users\\sebas\\OneDrive\\Documentos\\NetBeansProjects\\gestion_ventas\\Eventos.csv");//aqui hay que poner la ruta en la que tengan el archivo csv
